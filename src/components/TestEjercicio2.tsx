...
const questions = [
    ...
    {
        question: "¿Cuál es la ventaja principal de Lazy Loading?",
        options: [
            "Mejora la velocidad de carga de la página",
            "Reduce el tamaño de las imágenes",
            "Hace que la página sea más atractiva visualmente",
        ],
        answer: "Mejora la velocidad de carga de la página",
    },
    {
        question: "¿Qué método de Lazy Loading es más común en imágenes?",
        options: [
            "Usar el atributo `loading='lazy'`",
            "Configurar imágenes en un servidor CDN",
            "Usar imágenes en formato WebP",
        ],
        answer: "Usar el atributo `loading='lazy'`",
    },
];
...
const TestEjercicio2 = () => {
    ...
    return (
        <div className="p-6 max-w-xl mx-auto bg-white shadow-md rounded-md">
            <h2 className="text-2xl font-semibold text-center text-gray-800 mb-6">Test de Lazy Loading</h2>
