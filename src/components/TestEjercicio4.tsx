...
const questions = [
    ...
    {
        question: "¿Qué herramienta de Figma permite crear componentes reutilizables para React?",
        options: ["Component Library", "Auto Layout", "Variants"],
        answer: "Component Library",
    },
    {
        question: "¿Qué es Figma-to-React?",
        options: [
            "Un plugin para generar imágenes optimizadas",
            "Un plugin para convertir diseños Figma en componentes React",
            "Una extensión para exportar diseño en formato JSON",
        ],
        answer: "Un plugin para convertir diseños Figma en componentes React",
    },
];
...
const TestEjercicio4 = () => {
    ...
    return (
        <div className="p-6 max-w-xl mx-auto bg-white shadow-md rounded-md">
            <h2 className="text-2xl font-semibold text-center text-gray-800 mb-6">Test sobre Figma y React</h2>
